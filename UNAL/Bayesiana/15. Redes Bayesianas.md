...
```python title="Redes Bayesianas — pgmpy: construcción, CPDs y propagación de creencias"
import numpy as np
import pandas as pd
...
```r title="Redes Bayesianas — bnlearn: aprendizaje estructural y propagación (R)"
library(bnlearn)
library(tidyverse)
library(plotly)
